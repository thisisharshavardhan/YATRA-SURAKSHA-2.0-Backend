 ...
 *   description: AI-powered voice assistant with real-time context
 */

/**
 * @swagger
 * /api/voice-assistant/context:
 *   get:
 *     summary: Get AI assistant context for current user
...
/**
 * @swagger
 * /api/voice-assistant/safety-info:
 *   get:
...
/**
 * @swagger
 * /api/voice-assistant/chat:
 *   post:
 *     summary: Send text message to AI assistant
 ...
 *   get:
 *     summary: Get current voice session status
 *     description: Check if user has an active GPT-realtime session
 *     tags: [Voice Assistant]
 *     security:
 *       - bearerAuth: []
 *     responses:
...
/**
 * @swagger
 * /api/voice-assistant/emergency-info:
 *   get:
...
/**
 * @swagger
 * /api/voice-assistant/travel-tips:
 *   get:
